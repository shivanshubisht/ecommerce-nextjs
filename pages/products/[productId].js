            ...
            <section class="text-gray-600 body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex justify-center flex-wrap">
                        <Image src={product.images[0]} class="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" alt={product.title} width={300} height={300} />
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div class="flex mb-4">
                                <span class="flex items-center">
                                    ...
                                    <span class="text-gray-600 ml-3">{product.rating.rate}</span>
                                </span>
                            </div>
                            <p class="leading-relaxed">{product.description}</p>
                            <div class="flex">
                                <span class="title-font font-medium text-2xl text-gray-900">${product.price}</span>
                                <button class="flex ml-auto text-white bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-600 rounded">Add to Cart</button>
